/*
    * This file is responsible for handling the transcription process.
    * It listens for messages from the main thread and sends messages back to the main thread.
    * It uses the OpenAI whisper API to transcribe the audio.
*/
...
async function transcribe(audio) {
  ...
  await pipeline(audio, {
    ...
    chuck_callback: generationTracker.chunkCallback.bind(generationTracker),
  });
...
class GenerationTracker {
  constructor(pipeline, stride_length_s) {
    ...
    this.time_precision =
      ...
      pipeline.model.config.positions;
